...
public class ClassifiedStrategy implements PlacementStrategy<ClassifcationContext> {

    private static final Logger log = LogManager.getLogger(ClassifiedStrategy.class);
